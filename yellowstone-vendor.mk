...
PRODUCT_COPY_FILES += \
    vendor/google/yellowstone/proprietary/vendor/lib/libfcamdng.so:system/lib/libfcamdng.so \
    vendor/google/yellowstone/proprietary/vendor/lib/libnvcam_imageencoder.so:system/vendor/lib/libnvcam_imageencoder.so \
    vendor/google/yellowstone/proprietary/vendor/lib/libnvcamerahdr.so:system/vendor/lib/libnvcamerahdr.so \
    vendor/google/yellowstone/proprietary/vendor/lib/libnvcamerahdr_v3.so:system/vendor/lib/libnvcamerahdr_v3.so \
    vendor/google/yellowstone/proprietary/vendor/lib/libnvcap_video.so:system/vendor/lib/libnvcap_video.so \
    vendor/google/yellowstone/proprietary/vendor/lib/libpowerservice_client.so:system/vendor/lib/libpowerservice_client.so \
    vendor/google/yellowstone/proprietary/vendor/lib/hw/power.tegra.so:system/vendor/lib/hw/power.tegra.so \
    ...
    vendor/google/yellowstone/proprietary/vendor/lib/hw/lights.tegra.so:system/lib/hw/lights.tegra.so \
